...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ru": {
        ...
        "assets.brand.generic_title": "🏷 Логотип мероприятия",
        "assets.brand.generic_hint": "Загрузите прозрачный PNG логотипа вашего мероприятия. Если не загружен — показывается название tenant.",
        "assets.sponsors.empty_tenant": "Пока нет логотипов спонсоров. Загрузите логотипы партнёров — они появятся на билете. Для нового tenant репозиторий не используется.",
        "assets.partners.empty_tenant": "Для этого tenant партнёрские логотипы из репозитория не показываются. Загрузите свои.",
        "assets.directions.empty_tenant": "Баннеров пока нет.",
        "assets.brand.hint": (
        ...
        "tenant.form.event_section": "🎟 Брендинг мероприятия",
        "tenant.form.event_date_text_ru": "Дата заезда участников (RU)",
        "tenant.form.event_date_text_uz": "Дата заезда участников (UZ)",
        "tenant.form.event_venue_text_ru": "Площадка (RU)",
        ...
        "tenant.form.event_hint": "Дата заезда печатается в билете и в сообщении «Заезд участников — …». «Инструкция участникам» добавляется к этому же сообщению. Пусто — предложение опускается.",
        ...
        "tenant.directions.heading": "Направления tenant {name}",
        "tenant.directions.create": "➕ Добавить направление",
        "tenant.directions.empty": "Направлений пока нет. Добавьте первое.",
        "tenant.directions.col_name": "Название",
        "tenant.directions.col_canonical": "Canonical",
        "tenant.directions.col_parent": "Родитель",
        "tenant.directions.col_group": "Группа",
        "tenant.directions.col_sort": "Порядок",
        "tenant.directions.col_status": "Статус",
        "tenant.directions.col_actions": "Действия",
        "tenant.directions.group_hint": "Категории с одинаковой группой взаимоисключающие: участник выбирает в боте только одну из них — новый выбор молча заменяет предыдущий.",
        "tenant.directions.group_none": "—",
        "tenant.directions.edit": "Изменить",
        "tenant.directions.delete": "Удалить",
        "tenant.directions.confirm_delete": "Удалить направление? Исторические заявки сохранятся.",
        "tenant.directions.active": "✅ активно",
        "tenant.directions.inactive": "⏸ скрыто",
        "tenant.directions.back": "← К tenants",
        "tenant.directions.manage": "📂 Направления",
        "tenant.direction.create.title": "Добавить направление — {name}",
        "tenant.direction.edit.title": "Изменить направление — {name}",
        "tenant.direction.form.canonical": "Canonical (хранимое имя)",
        "tenant.direction.form.label_ru": "Название RU",
        "tenant.direction.form.label_uz": "Название UZ",
        "tenant.direction.form.slug": "Slug",
        "tenant.direction.form.parent": "Родитель (пусто = корень)",
        "tenant.direction.form.exclusive_group": "Группа (одиночный выбор)",
        "tenant.direction.form.hint_exclusive_group": "Категории с одинаковой группой взаимоисключающие: в боте выбрать можно только одну, новая молча заменяет предыдущую (например: spl, front, rear, bass_race). Пусто — обычная категория.",
        "tenant.direction.form.sort_order": "Порядок сортировки",
        "tenant.direction.form.is_active": "Активно",
        "tenant.direction.form.hint_canonical": "Например: SPL Тюнинг — Show, сохраняется как Parent — Child для podnapravleniya",
        "tenant.direction.form.hint_slug": "Только латиница, цифры, _ и -. Используется для баннеров.",
        "tenant.direction.form.err_canonical": "Укажите canonical",
        "tenant.direction.form.err_slug": "Slug некорректен",
        "tenant.direction.form.err_parent": "Родитель не найден или уже имеет родителя (максимум 2 уровня)",
        "tenant.direction.form.err_generic": "Не удалось сохранить направление: {detail}",
        ...
        "settings.event_section": "🎟 Брендинг мероприятия",
        "settings.event_date_text_ru": "Дата заезда участников (RU)",
        "settings.event_date_text_uz": "Дата заезда участников (UZ)",
        "settings.event_venue_text_ru": "Площадка (RU)",
        ...
        "messages.section": "Тексты сообщений участнику",
        "messages.approved_text_ru": "Текст после одобрения (RU)",
        "messages.approved_text_uz": "Текст после одобрения (UZ)",
        "messages.rejected_text_ru": "Текст при отклонении (RU)",
        "messages.rejected_text_uz": "Текст при отклонении (UZ)",
        "messages.hint": "Пустое поле — бот отправит свой стандартный текст. Можно вставлять: {number} — номер, {name} — имя, {plate} — госномер, {direction} — категории, {event} — название, {date} — дата заезда, {venue} — площадка, {channel} — канал.",
        "settings.event_hint": "Дата заезда печатается в билете и в сообщении «Заезд участников — …». «Инструкция участникам» добавляется к этому же сообщению.",
    ...
    "uz": {
        ...
        "assets.brand.generic_title": "🏷 Tadbir logotipi",
        "assets.brand.generic_hint": "Tadbir logotipining shaffof PNG faylini yuklang. Yuklanmasa — tenant nomi ko‘rinadi.",
        "assets.sponsors.empty_tenant": "Hozircha homiy logotiplari yo‘q. Hamkor logotiplarini yuklang — ular biletda paydo bo‘ladi. Yangi tenant uchun repozitoriy ishlatilmaydi.",
        "assets.partners.empty_tenant": "Bu tenant uchun repozitoriydagi hamkor logotiplari ko‘rsatilmaydi. O‘zingiznikini yuklang.",
        "assets.directions.empty_tenant": "Hozircha bannerlar yo‘q.",
        "assets.brand.hint": (
        ...
        "tenant.form.event_section": "🎟 Tadbir brendingi",
        "tenant.form.event_date_text_ru": "Ishtirokchilar kirish sanasi (RU)",
        "tenant.form.event_date_text_uz": "Ishtirokchilar kirish sanasi (UZ)",
        "tenant.form.event_venue_text_ru": "Maydon (RU)",
        ...
        "tenant.form.event_hint": "Kirish sanasi biletda va «Ishtirokchilar kirishi — …» xabarida chiqadi. «Ishtirokchilar uchun ko‘rsatma» shu xabarga qo‘shiladi. Bo‘sh — gap tushirib qoldiriladi.",
        ...
        "tenant.directions.create": "➕ Yo‘nalish qo‘shish",
        "tenant.directions.empty": "Hozircha yo‘nalishlar yo‘q. Birinchisini qo‘shing.",
        "tenant.directions.col_name": "Nomi",
        "tenant.directions.col_canonical": "Canonical",
        "tenant.directions.col_parent": "Ota",
        "tenant.directions.col_group": "Guruh",
        "tenant.directions.col_sort": "Tartib",
        "tenant.directions.col_status": "Holat",
        "tenant.directions.col_actions": "Amallar",
        "tenant.directions.group_hint": "Bir xil guruhdagi kategoriyalar o‘zaro istisno: ishtirokchi botda ulardan bittasini tanlaydi — yangi tanlov avvalgisini almashtiradi.",
        "tenant.directions.group_none": "—",
        "tenant.directions.edit": "Tahrirlash",
        "tenant.directions.delete": "O‘chirish",
        "tenant.directions.confirm_delete": "Yo‘nalish o‘chirilsinmi? Tarixiy arizalar saqlanadi.",
        "tenant.directions.active": "✅ faol",
        "tenant.directions.inactive": "⏸ yashirin",
        "tenant.directions.back": "← Tenantlarga",
        "tenant.directions.manage": "📂 Yo‘nalishlar",
        "tenant.direction.create.title": "Yo‘nalish qo‘shish — {name}",
        "tenant.direction.edit.title": "Yo‘nalishni tahrirlash — {name}",
        "tenant.direction.form.canonical": "Canonical (saqlanadigan nom)",
        "tenant.direction.form.label_ru": "Nomi RU",
        "tenant.direction.form.label_uz": "Nomi UZ",
        "tenant.direction.form.slug": "Slug",
        "tenant.direction.form.parent": "Ota (bo‘sh = ildiz)",
        "tenant.direction.form.exclusive_group": "Guruh (bitta tanlov)",
        "tenant.direction.form.hint_exclusive_group": "Bir xil guruhdagi kategoriyalar botda o‘zaro istisno: bittasini tanlash mumkin, yangi tanlov avvalgisini almashtiradi (masalan: spl, front, rear, bass_race). Bo‘sh — oddiy kategoriya.",
        "tenant.direction.form.sort_order": "Saralash tartibi",
        "tenant.direction.form.is_active": "Faol",
        "tenant.direction.form.hint_canonical": "Masalan: SPL Тюнинг — Show, Parent — Child sifatida saqlanadi",
        "tenant.direction.form.hint_slug": "Faqat lotin, raqam, _ va -. Bannerlar uchun ishlatiladi.",
        "tenant.direction.form.err_canonical": "Canonical kiriting",
        "tenant.direction.form.err_slug": "Slug noto‘g‘ri",
        "tenant.direction.form.err_parent": "Ota topilmadi yoki allaqachon otasi bor (maks 2 daraja)",
        "tenant.direction.form.err_generic": "Yo‘nalishni saqlab bo‘lmadi: {detail}",
        ...
        "settings.event_section": "🎟 Tadbir brendingi",
        "settings.event_date_text_ru": "Ishtirokchilar kirish sanasi (RU)",
        "settings.event_date_text_uz": "Ishtirokchilar kirish sanasi (UZ)",
        "settings.event_venue_text_ru": "Maydon (RU)",
        ...
        "messages.section": "Ishtirokchiga xabar matnlari",
        "messages.approved_text_ru": "Tasdiqlangandan keyingi matn (RU)",
        "messages.approved_text_uz": "Tasdiqlangandan keyingi matn (UZ)",
        "messages.rejected_text_ru": "Rad etilganda matn (RU)",
        "messages.rejected_text_uz": "Rad etilganda matn (UZ)",
        "messages.hint": "Bo‘sh maydon — bot o‘zining standart matnini yuboradi. Qo‘yish mumkin: {number} — raqam, {name} — ism, {plate} — davlat raqami, {direction} — kategoriyalar, {event} — nomi, {date} — kirish sanasi, {venue} — maydon, {channel} — kanal.",
        "settings.event_hint": "Kirish sanasi biletda va «Ishtirokchilar kirishi — …» xabarida chiqadi. «Ishtirokchilar uchun ko‘rsatma» shu xabarga qo‘shiladi.",
